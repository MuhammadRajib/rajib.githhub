...
// Dirubah 
const pengirim = "RAJIB";
const nomorWa = "6281262527231" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `Sekarang setelah saya selesai mengirimimu pesan. Saya akan mulai terobsesi menatap ponselku, menunggunya berbunyi, jadi tolong jangan biarkan saya lama menunggu balasanmu.`;

if (pengirim) {
  nama.innerHTML = pengirim;
  nama1.innerHTML = pengirim;
} else {
  nama.innerHTML = "Nama Kamu RAJIB";
  nama1.innerHTML = "Nama Kamu Rajib";
}
  ...
  Swal.fire({
    ...
    const typeWriter = () => {
      if (i < txt.length) {
        ...
        body.classList.replace('love', 'background2')
